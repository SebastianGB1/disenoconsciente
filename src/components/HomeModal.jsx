            ...
            <div className="border-0 rounded-3xl shadow-lg relative flex flex-col w-full bg-blanco outline-none focus:outline-none">
              ...
              <div className="m-5 mb-16">
                ...
                <h4 className="font-cooper my-10 text-xs md:text-base">
                  ABCDEFGHIJKLMNÑOPQRSTUVWXYZ
                  <p className="float-right text-xs md:text-base">
                    Cooper Black
                  </p>
                </h4>
                <h4 className="font-cooper my-10 text-xs md:text-base">
                ...
                <h4 className="font-cooper text-xs md:text-base">
                  1234567890.,-/*-+|
                </h4>
              </div>
              ...
              <div className="mx-5 ">
                <h3 className="text-cafe font-raleway text-sm sm:text-base ">
                  Tipografía alterna (Textos de corridos y comunicación de la
                  marca)
                </h3>
              </div>
              <div className="flex flex-row mx-5 justify-between mb-20">
                <div className="flex flex-col">
                  <h1 className="font-kiona mt-10 text-xs md:text-base">
                    ABCDEFGHIJKLMNÑOPQRSTUVWXYZ
                  </h1>
                  <h2 className="font-raleway my-10">
                    abcdefghijklmnñopqrstuvwxyz
                  </h2>
                  <h3 className="font-raleway">1234567890.,-/*-+|</h3>
                </div>
                <div className="flex flex-col items-end justify-around">
                  <p className="font-raleway font-thin text-xs md:text-base">
                    Raleway Thin
                  </p>
                  <p className="font-raleway font-extralight text-xs md:text-base">
                    Raleway Light
                  </p>
                  <p className="font-raleway text-xs md:text-base">
                    Raleway Regular
                  </p>
                  <p className="font-raleway font-medium text-xs md:text-base">
                    Raleway Medium
                  </p>
                  <p className="font-raleway font-bold text-xs md:text-base">
                    Raleway Bold
                  </p>
                  <p className="font-raleway font-black text-xs md:text-base">
                    Raleway Black
                  </p>
                  <p className="font-raleway italic text-xs md:text-base">
                    Raleway Italic
                  </p>
                </div>
              </div>
              ...
              <div>
                <p className="text-black font-raleway text-xxs  mx-10 mt-9 mb-5">
                  <LazyLoadImage
                    ...
                    className="w-2 h-2 float-left"
                  />
                  Las imágenes son generadas por BlueWillow, un emocionante
                  generador de imágenes por Inteligencia Artificial (IA) que ha
                  revolucionado la forma en que se crea y se imagina el arte
                  visual. Utilizando técnicas avanzadas de aprendizaje profundo,
                  BlueWillow puede generar imágenes impresionantes, realistas y
                  detalladas a partir de descripciones de texto. Esta poderosa
                  herramienta utiliza una vasta cantidad de datos visuales
                  previamente entrenados para comprender las sutilezas de la
                  forma, el color, la textura y la composición, y luego traduce
                  esas descripciones en imágenes impactantes. BlueWillow ha
                  abierto nuevas fronteras creativas y ha permitido a artistas,
                  diseñadores y creadores explorar posibilidades ilimitadas en
                  el ámbito visual, ofreciendo una herramienta innovadora para
                  la expresión artística y la comunicación visual.
                </p>
              </div>
            </div>
          </div>
